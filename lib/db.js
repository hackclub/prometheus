...
const statements = {
  ...
  deactivateCurrentAnchorPoll: db.query('UPDATE anchor_polls SET is_current = 0 WHERE channel_id = $channelId AND is_current = 1'),
  ...
  setAnchorPollEnabled: db.query('UPDATE anchor_polls SET enabled = $enabled WHERE channel_id = $channelId AND is_current = 1'),
